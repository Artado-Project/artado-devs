...
<body>
                ...
                <section class="section">
                    <?php if (count($projects) > 0): ?>
                        <?php foreach ($projects as $project): 
                            // Profil fotoğrafını ve proje resmini hazırla
                            $profile_photo = get_user_avatar($project['profile_photo'] ?? null, true);
                            
                            $db_img_path = $project['image_path'] ?? null;
                            if ($db_img_path) {
                                // DB'deki yolu temizleyip user klasöründen erişilecek hale getir
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <?php else: ?>
                                                        <img src="<?php echo $default_profile_photo; ?>" alt="Varsayılan Proje Resmi" 
                                                             class="img-fluid rounded">
                                                    <?php endif; ?>
                                                </div>
                                                <div class="col-md-8">
                    ...
                    <div class="modal-body">
                        ...
                        <div id="current_image" class="mb-3">
                            ...
                            <div class="text-center p-3 border rounded">
                                <img src="" alt="Mevcut Proje Resmi" class="img-fluid rounded" style="max-height: 200px;">
                            </div>
                        </div>
    ...
    function openEditModal(project) {
        ...
        if (project.image_path) {
            ...
            currentImage.src = '<?php echo $default_profile_photo; ?>';
            currentImage.parentElement.style.display = 'block';
        }
